...
alias mysql-dataava='mysql -uroot -proot -h 127.0.0.1'
...
alias irc="AUTOSSH_POLL=120 autossh oma -t tmux at"
alias sa=script/aava
alias ad='cd /home/msm/workspace/aava/development/'
alias ..='cd ..'
alias ...='cd ../../'
alias ....='cd ../../../'
alias .....='cd ../../../../'
...
set_prompt() {
  ...
  if [ -n "$git_repo" -a -n "$git_branch" ] ; then
    PS1+=" \\[\\033[01;33m\\]$git_repo \\[\\033[00;33m\\]$git_branch\\[\\033[00m\\]"
  fi
